...
#include "../include/preprocids.h"
#include "../include/sf_snort_packet.h"
#include "../include/sf_dynamic_preproc_lib.h"
#include "../include/sf_dynamic_preprocessor.h"
#include "../include/snort_debug.h"
#include "../include/sfPolicy.h"
#include "../include/sfPolicyUserData.h"
}
...
void ExampleProcess(void *pkt, void *context)
{
    ...
    // 送信元IPをチェック
    // KVSを送信元IPで検索
    // KVSに該当があったら、アラートを上げる
    // このアラートは相関の元に使わないように何かの目印をつける



_dpd.logMsg("ExampleProcess was called\n");
char buf[256];
sprintf(buf, "src port %d dst port %d\n", p->src_port, p->dst_port);
_dpd.logMsg(buf);
...
_dpd.logMsg("source port matched\n");
...
_dpd.logMsg("destination port matched\n");
